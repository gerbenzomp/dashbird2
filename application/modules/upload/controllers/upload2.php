...
class Upload2 extends MX_Controller
{
	...
	function __construct()
	{
		...
		$this->setPath_img_upload_folder(APPPATH."../uploads/");
		$this->setPath_img_thumb_upload_folder(APPPATH."../uploads/thumbs/");
		...
		$this->setPath_url_img_thumb_upload_folder(base_url() . "uploads/thumbs/");
	}
