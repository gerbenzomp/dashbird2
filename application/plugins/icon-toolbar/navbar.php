...
<a href="<?=base_url();?>" class="nav-button<?php if($CI->uri->segment(1)=='' || $CI->uri->segment(1)=='page'){ echo " current"; } ?>">Website</a><a href="<?=base_url();?>dashboard" class="nav-button<?php if($CI->uri->segment(1) && $CI->uri->segment(1)!='page'){ echo " current"; } ?>">Instellingen</a>
...
<?php if($CI->uri->segment(1)=='' || $CI->uri->segment(1)=='page'){ ?>
