...
// /var/www/vhosts/blogbird.nl/httpdocs/uploads/kamermuziekfestival/310510113820813_mission-1.jpg
...
if(strlen($src) && file_exists($src)) {
	...
	// which sites to sharpen
	$sharpened_sites = array('argibald', 'gerben', 'kamermuziekfestival', 'musicanexus');
	$site = explode('/', get_request("src", ""));
	$site = $site[0];
	

	
	if (in_array($site, $sharpened_sites) && function_exists ('imageconvolution') && get_request("w", 0) > 150) {
